...
package org.opennms.plugins.graph;
...
public class MyGraphContainerProvider implements GraphContainerProvider {
    ...
    public GraphContainer loadGraphContainer() {
        ...
        final List<Edge> edges = Lists.newArrayList(
                ...
                graphBuilderA.edge("e3", ImmutableVertexRef.newBuilder(NAMESPACE_1, "v1").build(), ImmutableVertexRef.newBuilder(NAMESPACE_2, "v1").build()).build()
        );
